hui.onReady(function() {
  ...
  var arc1 = d.addArc({center : center,fill : 'none', stroke:{color:'#999',width : '1px'}});
  var arc2 = d.addArc({center : center,fill : 'none', stroke:{color:'#999',width : '1px'}});
  var arc3 = d.addArc({center : center,fill : 'none', stroke:{color:'#999',width : '1px'}});
  var arc4 = d.addArc({center : center,fill : 'none', stroke:{color:'#999',width : '1px'}});
  
  var circle = d.addCircle({cx:center.x,cy:center.y,r:0,fill : 'none', stroke:{color:'#999',width : '1px'},width:0});
